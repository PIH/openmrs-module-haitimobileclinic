package org.openmrs.module.haitimobileclinic.search;
...
public class DefaultHaitiMobileClinicSearch implements HaitiMobileClinicSearch {
    ...
    public List<Patient> search(PersonName patientName) {
		...
		List<Patient> namePhoneticsPatients = HaitiMobileClinicUtil.findPatientsByNamePhonetics(patientName);
	...
	public Set<String> searchNames(String name, String nameField) {
		...
		return Context.getService(HaitiMobileClinicService.class).searchNames(name, nameField);		
	}
	...
	public List<Integer> getPhoneticsPersonId(String firstName, String lastName){
		...
		return Context.getService(HaitiMobileClinicService.class).getPhoneticsPersonId(firstName, lastName);
	}
	public Map<String,Integer> searchNamesByOccurence(String name, String nameField) {
		...
		return Context.getService(HaitiMobileClinicService.class).searchNamesByOccurence(name, nameField);		
	}
