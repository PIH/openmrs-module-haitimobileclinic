...
/**
 * The Interface HaitiMobileClinicService has the service methods for HaitiMobileClinic module.
 */
public interface HaitiMobileClinicService {
	...
	/**
	 * Searches for patients that match the given person name; Uses the search class referenced in haitimobileclinic.search global property, 
	 * otherwise uses the default patient search (DefaultHaitiMobileClinicSearch)
	 * 
	...
	/**
	 * Searches for patients that match the given first person name; Uses the search class referenced in haitimobileclinic.search global property, 
	 * otherwise uses the default patient search (DefaultHaitiMobileClinicSearch)
	 * 
	 * @param personName the name to search for
	 */
	 ...
	 * Uses the search class referenced in haitimobileclinic.search global property, 
	 * otherwise uses the default patient search (DefaultHaitiMobileClinicSearch)
	 * 
	...
	/**
	 * Searches for patients that match the given reference patient; Uses the search class referenced in haitimobileclinic.search global property, 
	 * otherwise uses the default patient search (DefaultHaitiMobileClinicSearch)
	 * 
