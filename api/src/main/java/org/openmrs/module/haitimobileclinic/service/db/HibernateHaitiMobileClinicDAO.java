 ...
 */
package org.openmrs.module.haitimobileclinic.service.db;
 ...
 */
public class HibernateHaitiMobileClinicDAO implements HaitiMobileClinicDAO {
	...
	/**
	 * @see HaitiMobileClinicDAO#getNumberOfEncountersByAddress(Map, String, EncounterType, Location)
	 */
	public Map<String, Integer> getNumberOfRegistrationsByAddress(Map<String, String> filterCriteria, String addressField, EncounterType encounterType, Location location, boolean groupByPatient) {
		...
		List<String> keys = HaitiMobileClinicUtil.getAddressHierarchyValues(addressField, filterCriteria);
		for (String key : keys) {
...
//					}
	...
	/**
	 * @see HaitiMobileClinicDAO#saveUserActivity(UserActivity)
	 */
