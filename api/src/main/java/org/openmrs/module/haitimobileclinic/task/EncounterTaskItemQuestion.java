...
public class EncounterTaskItemQuestion {
	...
	public void filterAnswers(Patient patient){
		...
		if(patient!=null && (HaitiMobileClinicUtil.getAgeInDays(patient.getBirthdate(), null)>=28) && this.answers!=null && (this.answers.size()>0)){
			Concept neonatalConcept = HaitiMobileClinicGlobalProperties.GLOBAL_PROPERTY_PRIMARY_CARE_VISIT_NEONATAL_DISEASES_CONCEPT();
