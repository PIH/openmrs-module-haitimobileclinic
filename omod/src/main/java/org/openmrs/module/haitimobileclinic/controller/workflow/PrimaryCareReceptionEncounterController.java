 ...
 */
@Controller
@RequestMapping(value = "/module/haitimobileclinic/workflow/primaryCareReceptionEncounter.form")
public class PrimaryCareReceptionEncounterController extends AbstractPatientDetailsController {
	...
	public ModelAndView showSelectPatient(
		...
		Concept visitReasonConcept = HaitiMobileClinicGlobalProperties.GLOBAL_PROPERTY_PRIMARY_CARE_RECEPTION_VISIT_REASON_CONCEPT();
		Concept paymentAmountConcept = HaitiMobileClinicGlobalProperties.GLOBAL_PROPERTY_PRIMARY_CARE_RECEPTION_PAYMENT_AMOUNT_CONCEPT();
		Concept receiptConcept = HaitiMobileClinicGlobalProperties.GLOBAL_PROPERTY_PRIMARY_CARE_RECEPTION_RECEIPT_NUMBER_CONCEPT();

		Locale locale = Context.getLocale();

		String visitReasonLabel = HaitiMobileClinicGlobalProperties.GLOBAL_PROPERTY_PRIMARY_CARE_RECEPTION_VISIT_REASON_CONCEPT_LOCALIZED_LABEL(locale);
		String paymentAmountLabel = HaitiMobileClinicGlobalProperties.GLOBAL_PROPERTY_PRIMARY_CARE_RECEPTION_PAYMENT_AMOUNT_CONCEPT_LOCALIZED_LABEL(locale);
		String receiptLabel = HaitiMobileClinicGlobalProperties.GLOBAL_PROPERTY_PRIMARY_CARE_RECEPTION_RECEIPT_NUMBER_CONCEPT_LOCALIZED_LABEL(locale);
		...
		EncounterType encounterType = HaitiMobileClinicGlobalProperties.GLOBAL_PROPERTY_PRIMARY_CARE_RECEPTION_ENCOUNTER_TYPE();	
		...
		return new ModelAndView("/module/haitimobileclinic/workflow/primaryCareReceptionEncounter");	
	...
	public ModelAndView processPayment(
		...
		if(StringUtils.isNotBlank(obsList)){			
			...
			List<Obs> observations = HaitiMobileClinicUtil.parsePaymentObsList(obsList, user);
