...
public class PrimaryCareReceptionTaskController extends AbstractPatientDetailsController{
	...
	@RequestMapping(value = "/module/haitimobileclinic/workflow/primaryCareReceptionTask.form", method = RequestMethod.GET)
	public ModelAndView showEnterPatientIdentifier(HttpSession session,  ModelMap model) {
		...
		return new ModelAndView("/module/haitimobileclinic/workflow/primaryCareReceptionTask");
	}
	
	
	@RequestMapping(value = "/module/haitimobileclinic/workflow/primaryCareReceptionCreateEncounterTaskItem.form", method = RequestMethod.GET)
	public ModelAndView showPrimaryCareReceptionCreateEncounterTaskItem(HttpSession session, ModelMap model, @RequestParam("patientId") Integer patientId) {
		...
		UserActivityLogger.logActivity(session, HaitiMobileClinicConstants.ACTIVITY_PRIMARY_CARE_RECEPTION_ENCOUNTER_STARTED);
	...
	@RequestMapping(value = "/module/haitimobileclinic/workflow/primaryCareReceptionCreateEncounterTaskItem.form", method = RequestMethod.POST)
	public ModelAndView handleSubmitPrimaryCareReceptionCreateEncounterTaskItem(
		...
		UserActivityLogger.logActivity(session, HaitiMobileClinicConstants.ACTIVITY_PRIMARY_CARE_RECEPTION_ENCOUNTER_COMPLETED);
	...
	private EncounterTaskItem initializeEncounterTaskItem(HttpSession session)  {
		...
		taskItem.setBackUrl("/module/haitimobileclinic/workflow/primaryCareReceptionTask.form");
		taskItem.setSuccessUrl("/module/haitimobileclinic/workflow/primaryCareReceptionDossierNumber.form");
