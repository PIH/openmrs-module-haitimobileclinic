 ...
 */
public class HaitiMobileClinicExt extends AdministrationSectionExt {
	...
	public String getTitle() {
		return "haitimobileclinic.title";
	}
	...
	public Map<String, String> getLinks() {
		...
		map.put("module/haitimobileclinic/workflow/selectLocationAndService.form", "haitimobileclinic.title");
		return map;
	}
