...
<table>	
	...
	<tr>
		...
		<td>
			<button id="checkmark-yellow" name="checkmark-yellow" class="checkmark-yellow" style="display:none; background : url('${pageContext.request.contextPath}/moduleResources/haitimobileclinic/images/checkmark-yellow.png');"></button>		
		</td>
	</tr>
</table>	
	<br/><br/>
