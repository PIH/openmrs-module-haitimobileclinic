...
<%@ taglib prefix="haitimobileclinic" uri="/WEB-INF/view/module/haitimobileclinic/resources/haitimobileclinic.tld" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<openmrs:htmlInclude file="/moduleResources/haitimobileclinic/utils.js"/>		
		<openmrs:htmlInclude file="/moduleResources/haitimobileclinic/haitimobileclinic.css" />
			
		<openmrs:htmlInclude file="/moduleResources/haitimobileclinic/autocomplete/js/jquery-1.6.2.min.js" />	
		<openmrs:htmlInclude file="/moduleResources/haitimobileclinic/autocomplete/js/jquery-ui-1.8.16.custom.min.js" />		
		<openmrs:htmlInclude file="/moduleResources/haitimobileclinic/autocomplete/css/ui-lightness/jquery-ui-1.8.16.custom.css" />
		
		<openmrs:htmlInclude file="/moduleResources/haitimobileclinic/jquery.printf.js" />	
...
<body>
  	...
  	<openmrs:authentication>
		<c:if test="${authenticatedUser == null}">
			...
			<span id="userLoggedOut" class="firstChild"> <spring:message code="haitimobileclinic.logged.out" /> </span>
			<span id="userLogIn">
				<a href="${pageContext.request.contextPath}/login.htm"><spring:message code="haitimobileclinic.login" /></a>
			</span>
		</c:if>
	</openmrs:authentication> 
	    	...
	    	<tr>
	    		<td align="left">
	    			<a href="${pageContext.request.contextPath}">
	    				<img class="logo" src="${pageContext.request.contextPath}/moduleResources/haitimobileclinic/images/PIH_ZL_plum-170x30.jpg"></img>
	    			</a>
	    		</td>
		    	<td class="loginString" style="vertical-align:middle;">
		    		...
		    		<span class="loginStringSection"><a href='${pageContext.request.contextPath}/module/haitimobileclinic/workflow/selectLocationAndService.form'>
		    			<spring:message code="haitimobileclinic.changeTask" />
		    		</a></span>
		    	</td>
	    	</tr>
	    </table>
