$j(document).ready(function(){
	...
	$j.navigateToPage = function() {
		...
		if(patientId.length>0){
			window.location.href=pageContextAddress + '/module/haitimobileclinic/workflow/mobileClinicReceptionEncounter.form?patientId=' + patientId;
		}else{
	...
	$j.submitPatientIdentifier=function(event){
		...
		$j('#confirmPatientModalDiv').load(pageContextAddress + '/module/haitimobileclinic/workflow/confirmPatient.form?patientIdentifier=' + patientIdentifier + ' #modalTable', 
			function(){				
				$j.hideOkButton();					
			}
		);								
