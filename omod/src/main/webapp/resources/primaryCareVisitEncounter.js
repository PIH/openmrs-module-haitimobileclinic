$j(document).ready(function(){	
	...
	$j.highlightRow= function(rowId){
			...
			$j("#plusBtnId").css("background-image", "url('" + pageContextAddress  + "/moduleResources/haitimobileclinic/images/plus-fade.png')");			
			...
			$j(".deleteDiagnosisClick").css("background", "url('" + pageContextAddress  + "/moduleResources/haitimobileclinic/images/x-grey.png')");
			...
			if(rowId == 'checkmark-yellow'){
				...
				$j("#plusBtnId").css("background-image", "url('" + pageContextAddress  + "/moduleResources/haitimobileclinic/images/plus.png')");
				...
				if(deleteBtn == null || deleteBtn == 'undefined'){
					...
					deleteBtn.css("background", "url('" + pageContextAddress  + "/moduleResources/haitimobileclinic/images/z-red.png')");
		...
		if(message.length>0){
			...
			$j("#dialog-ageRestrictedDisease").dialog({
				...
				open: function(event, ui){								
					...
					$j("#okBtnAgeRestricted").css("background", "url('" + pageContextAddress  + "/moduleResources/haitimobileclinic/images/checkmark-yellow.png') center center no-repeat");
	...
	$j.setAddDiagnosisDiv = function() {
		...
		$j.each(diagnosisArray, function(i, diagnosis){			
			...
			deleteDiagnosisBtn.css("background", "url('" + pageContextAddress  + "/moduleResources/haitimobileclinic/images/x-grey.png')");
	...
	$j("#plusEncounterBtnId").click(function(event){
		...
		window.location.href=pageContextAddress + '/module/haitimobileclinic/workflow/primaryCareReceptionEncounter.form?nextTask=primaryCareVisitEncounter.form&createNew=true&patientId=' + patientId;
	});
	...
	$j("#uncodedMessageArea").dialog({
			...
			open: function(event, ui){		
				...
				$j("#okBtnConf").css("background", "url('" + pageContextAddress  + "/moduleResources/haitimobileclinic/images/checkmark-yellow.png')");
				$j("#okBtnConf").focus();			
			}, 
			close: function(event, ui){	
