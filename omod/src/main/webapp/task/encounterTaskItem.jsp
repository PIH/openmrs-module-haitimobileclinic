...
<openmrs:htmlInclude file="/moduleResources/haitimobileclinic/encounterTaskItem.js"/>
...
<div class="middleArea">
	<div class="menu" id="menuArea">
		<table class="menu">
			...
			<tr>
				<td class="menu nameMenu${menuItem}"><spring:message code="haitimobileclinic.taskItem.encounter.confirmDetails"/></td>
			</tr>
		</table>
	</div>
	<div class="partBar mainArea largeFont">
					...
					<tr>
						<td>	
							...
							<table width="100%" class="questionBox">	
								...
								<tr> 
									<td class="questionAnswer" id="question${page}AnswerValueSkipEncounterDate"><openmrs:formatDate date="${taskItem.encounterDate}" format="${_dateFormatDisplayDash}"/> (<spring:message code="haitimobileclinic.today"/>)</td>
								...
								<tr> 
									<td class="questionAnswer" id="question${page}AnswerValue0"><spring:message code="haitimobileclinic.taskItem.encounter.pastVisit"/></td> <!-- TODO: "past visit" should be customizable -->
								</tr>						
							</table>
						</td>						
					</tr>
		...
		<c:if test="${taskItem.encounterDateEditable}">
			...
			<div id="page${page}" style="display:none" class="padded">	
				<table height="100%" width="900px">
					...
					<tr>
						<td colspan="4">
							<i class="leftalign"><spring:message code="haitimobileclinic.encounterDate"/>: <span class="review${page - 1}"><openmrs:formatDate date='${taskItem.encounterDate}' format='yyyy'/></span></i>
						</td>											
					</tr>	
			...
			<div id="page${page}" style="display:none" class="padded">	
				<table height="100%" width="100%">			
					...
					<tr>
						<td colspan="4">
							<i class="leftalign"><spring:message code="haitimobileclinic.encounterDate"/>: <span class="review${page - 1}"><openmrs:formatDate date='${taskItem.encounterDate}' format='MMMMMMMM'/></span>-<span class="review${page - 2}"><openmrs:formatDate date='${taskItem.encounterDate}' format='yyyy'/></span></i>
						</td>											
					</tr>	
		...
		<div id="page${page}" style="display:none" class="padded">
			...
			<table height="100%" width="100%">												
				<tr>
					<td>
						<b class="leftalign"><spring:message code="haitimobileclinic.taskItem.encounter.confirmDetailsMessage"/>:</b>
					</td>											
				</tr>
				...
				<c:if test="${taskItem.encounterDateEditable}">
					...
					<tr>
						<td class="questionLabelSmall"><spring:message code="haitimobileclinic.encounterDate"/></td>
					</tr>
							...
							<table width="75%">	
								<tr>
									...
									<td width="20%" class="leftalign">
										<img class="editButton" id="edit${questionNumber}" src="${pageContext.request.contextPath}/moduleResources/haitimobileclinic/images/edit-button.png"" width="54" height="56"/>
									</td>
								</tr>						
							</table>
						</td>
							...
							<td>
								<table width="75%">	
									<tr>
										...
										<td width="20%" class="leftalign"><img class="editButton" id="edit${questionNumber}" src="${pageContext.request.contextPath}/moduleResources/haitimobileclinic/images/edit-button.png"" width="54" height="56"/></td>
									</tr>						
								</table>
							</td>
						</tr>
