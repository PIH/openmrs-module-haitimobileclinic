...
<openmrs:htmlInclude file="/moduleResources/haitimobileclinic/mobileClinicReceptionEncounter.js"/>
...
<script type="text/javascript">
    ...
    var tbScreeningConceptId  = '${tbScreening.concept.id}';
    var tbScreeningConceptName = '${!empty tbScreening.label ? tbScreening.label : tbScreening.concept.name}';
...
<div id="tbScreeningDiv" name="tbScreeningDiv" class="padded hiddenDiv">
    <table class="maxSize">
        <tr>
            <td>
                <table align="center" align="left" width="100%">
                    <tr valign="top">
                        <td align="left" style="padding: 5px">
                            <b class="leftalign">${!empty tbScreening.label ? tbScreening.label : tbScreening.concept.name}</b>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            <table width="100%" valign="top" style="border: solid 1px;">
                                <tr>
                                    <td align="left" style="padding: 0px">
                                        <table id="tbScreeningTable"  name="tbScreeningTable" class="questionBox tbScreeningList" width="100%">
											<input type="hidden" id="tbScreeningObsId" name="tbScreeningObsId" value="" />
                                            <c:forEach var="tbScreeningStatus" items="${tbScreening.answers}" varStatus="i">
                                                ...
                                                <tr id="tbScreeningStatusRow${i.count}" class="tbScreeningListRow ${rowColor}">
                                                    <td class="questionAnswer" id="tbScreeningStatus${i.count}">${tbScreeningStatus.key}
                                                        <input type="hidden" id="tbScreeningStatusId" value="${tbScreeningStatus.value}"/>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </table>
...
<div id="confirmMessageArea" class="hiddenDiv">
    <spring:message code="haitimobileclinic.confirm"/>
</div>
