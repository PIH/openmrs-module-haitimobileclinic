...
<openmrs:htmlInclude file="/moduleResources/haitimobileclinic/primaryCareVisitEncounter.js"/>
...
<script type="text/javascript">
	...
	var jsPatientAgeMsg = '<spring:message code="haitimobileclinic.patientAgeMsg"/>';
	...
	var providerLabel = '<spring:message code="haitimobileclinic.provider"/>';
	...
	<table class="menu">
		...
		<tr>
			<td class="menu highlighted" id="providerMenu">
				<spring:message code="haitimobileclinic.provider"/>
			</td>
		</tr>
		<tr>
			<td class="menu" id="diagnosisMenu">
                <spring:message code="haitimobileclinic.diagnosis"/>
			</td>
		</tr>		
	...
	<div class="partBar mainArea largeFont">
		...
		<div id="encounterDateDiv" name="encounterDateDiv" class="padded">	
			<table height="100%" width="100%">												
				<tr>
					<td>
						<b class="leftalign"><spring:message code="haitimobileclinic.selectVisitDate"/></b>
					</td>											
				</tr>								
				<tr>
					<td>	
							...
							<c:forEach var="patientDiag" items="${patientDiagnosis}" varStatus="i">             
								...
								<tr id="receptionTr${patientDiag.receptionEncounterId}" class="dateListRow biggerRow ${rowColor} ${highClass}">		
									...
									<td class="questionAnswer" id="receptionTd${patientDiag.receptionEncounterId}">										
										<haitimobileclinic:pocFormatDate date="${patientDiag.receptionEncounterDate}" format="${_dateFormatDisplayDash}"/>
											<c:if test="${patientDiag.today == true}"><span class="boldFont">(<spring:message code="haitimobileclinic.today"/>)</span></c:if> 
											<c:forEach var="patientObs" items="${patientDiag.patientObservation}" varStatus="j">
						...
						<table class="maxSize">
							<tr id="plusEncounterRow" class="left rowToHighlight">						
								<td id="plusEncounterLabelColumn" width="25%" class="smallerFont">							
									<spring:message code="haitimobileclinic.visitNotListed"/>?<br>
									<spring:message code="haitimobileclinic.addReceptionEncounter"/>:<br>
								</td>
					...
					<td>
						<table width="95%">
							<tr>
								<td align="left">
									<b>
										<spring:message code="haitimobileclinic.addProvider"/>
									</b>
								</td>								
							</tr>
						</table>
				...
				<table id="plusDiagnosisTable" name="plusDiagnosisTable" height="100%" width="100%" cellpadding="20">										
					<tr id="plusDiagnosisRow" name="plusDiagnosisRow" class="leftalign rowToHighlight" style="width:450px;">
						<td id="jsAddDiagnosisId" name="jsAddDiagnosisId" class="padded" style="width:100%;">
							<span id="addDiagnosisLabelId" class="boldFont"><spring:message code="haitimobileclinic.addDiagnosis"/></span>
						</td>										
		...
		<div id="dialog-urgentDisease" name="dialog-urgentDisease" title='<spring:message code="haitimobileclinic.notifiableDisease"/>?' class="padded hiddenDiv">	
			<table class="maxSize">							
				<tr>
					<td>
						<b><span style="font-size:1.3em; color:black; text-align:center;"><spring:message code="haitimobileclinic.reportDisease"/>!</span></b>
						<br>
						<br>
		...
		<div id="dialog-ageRestrictedDisease" name="dialog-ageRestrictedDisease" title='<spring:message code="haitimobileclinic.ageRestrictedDisease"/>' class="padded hiddenDiv">	
			<table class="maxSize">							
				<tr>
					<td>
						<b><span id="patientAgeMsg" name="patientAgeMsg" style="font-size:1.3em; color:black; text-align:center;"></span></b>
						<br>
						<b><span style="font-size:1.3em; color:black; text-align:center;"><spring:message code="haitimobileclinic.reportAgeRestrictedDisease"/>?</span></b>
						<br>
						<br>
