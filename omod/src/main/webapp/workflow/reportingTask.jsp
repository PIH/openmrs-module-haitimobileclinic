...
<openmrs:htmlInclude file="/moduleResources/haitimobileclinic/reportingTask.js"/>
...
<div class="middleArea">
	...
	<div class="menu" id="menuArea">
		<table class="menu">
			<tr>
				<th class="reportMenu" style="font-size: 1.2em"><spring:message code="haitimobileclinic.tasks.${registration_task}"/></th>
			</tr>
			<tr>
				...
				<tr>
					<td valign="top" class="labelSmall">
						...
						<div id="downloadReportDiv" class="hiddenDiv">						
							<button onClick="window.location.href='${pageContext.request.contextPath}/module/haitimobileclinic/workflow/reportingTask.form?reportDownload=true&uuid=${request.uuid}';" style="width:150px; height:40px;">
						...
						<div id="runAgainDiv" class="hiddenDiv">
							<button onClick="window.location.href='${pageContext.request.contextPath}/module/haitimobileclinic/workflow/reportingTask.form?runAgain=true&copyRequest=${request.uuid}';" style="width:100px; height:40px;">
