...
<table style="width: 90%; cell-padding: 20px;" >
	<tr>
		<th style="text-align: left;"><spring:message code="haitimobileclinic.person.enterBirthdate"/></th>
...
<table class="maxSize">
	<tr valign="center">
		...
		<td><img class="cross-red" align="left"
			src="${pageContext.request.contextPath}/moduleResources/haitimobileclinic/images/cross-red.png"></img></td>
	</tr>
</table>
</div>
...
<table class="maxSize">
 ...
 <td width="20%"><img class="left-arrow"
   	  src="${pageContext.request.contextPath}/moduleResources/haitimobileclinic/images/left-arrow-white.png"></img></td>
 <td>(bottomBar)</td>  	  
 <td width="20%"><img class="right-arrow"
   	  src="${pageContext.request.contextPath}/moduleResources/haitimobileclinic/images/right-arrow-white.png"></img></td>
</tr>
</table>
</div>