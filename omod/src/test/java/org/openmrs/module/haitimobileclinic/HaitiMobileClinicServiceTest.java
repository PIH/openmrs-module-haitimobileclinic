...
public class HaitiMobileClinicServiceTest extends BaseModuleContextSensitiveTest {
	...
	public void registerPatient_shouldRegisterPatient() throws Exception {
		...
		Context.getService(HaitiMobileClinicService.class).registerPatient(patient, person, registration, location);
	...
	public void registerPatient_shouldCreateTwoRegistrationEncountersAtDifferentLocations() throws Exception {
		...
		Context.getService(HaitiMobileClinicService.class).registerPatient(patient, person, registration, location2);
		Context.getService(HaitiMobileClinicService.class).registerPatient(patient, person, registration, location3);
	...
	public void registerPatient_shouldCreateTwoRegistrationEncountersOnDifferentDays() throws Exception {
		...
		Context.getService(HaitiMobileClinicService.class).registerPatient(patient, person, registration, location);
		Context.getService(HaitiMobileClinicService.class).registerPatient(patient, person, registration, location, yesterday.getTime());
	...
	public void search_shouldReturnEmptyListWhenPassedEmptyPersonNameObject() throws Exception {
		...
		List<Patient> patients = Context.getService(HaitiMobileClinicService.class).search(name);
	...
	public void search_shouldReturnPatientList() throws Exception {
		...
		List<Patient> patientList = Context.getService(HaitiMobileClinicService.class).search(personName);
	...
	public void search_shouldReturnEmptyListWhenPassedEmptyPatientObject() throws Exception {
		...
		List<Patient> patients = Context.getService(HaitiMobileClinicService.class).search(patient);
